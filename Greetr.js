;(function (global, $) {
  ...
  Greetr.prototype = {
    ...
    // references the externally inaccessible 'supportedLangs' within the 
    // closure
    validate: function() {
    ...
    // retrieve messages from the object by referring to properties 
    // using [] syntax
    greeting: function() {
